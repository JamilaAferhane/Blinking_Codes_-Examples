...
//This code uses the temperature values measured by DH11 sensor to vary the frequency of blinking of two LEDs
...
void loop() {
  ...
  Serial.println(1000/blinkInterval); // printing the frequency of blinking on the serial port
